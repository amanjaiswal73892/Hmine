# This python script is used to Import the implemented Apriori and H-mine algorithms and trigger them using 3 Different datasets.
...
execution_time[1] = RunAlgo("Apriori", input_Dataset2, output_Dataset2_Apriori, 0.02)
...
execution_time[4] = RunAlgo("Hmine", input_Dataset2, output_Dataset2_H_mine, 0.02)
